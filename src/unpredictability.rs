//! Unpredictability analysis — measuring and characterizing chaotic behavior in time series.
...
/// Metric type for behavioral observations.
...
/// Behavior profile — summary statistics for monitoring.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Classification of behavioral regime.
...
/// Build a behavior profile from a scalar time series.
pub fn build_behavior_profile(series: &[f64]) -> BehaviorProfile {
...
mod tests {
    ...
    #[test]
    fn test_behavior_profile_random() {
